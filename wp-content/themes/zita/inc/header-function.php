...
?>	
<div id="site-navigation-pro" class="main-header <?php echo esc_attr($zita_main_header_layout);?> <?php echo esc_attr($zita_main_header_menu_align);?> <?php echo esc_attr($zitapro_menu_alignment);?> <?php echo esc_attr($zitapro_menu_effect);?>">
